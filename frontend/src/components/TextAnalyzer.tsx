    ...
    <div className="space-y-8">
      <div className="relative group">
        ...
        <Textarea
          ...
          className="relative min-h-[280px] bg-surface-container-lowest/80 backdrop-blur-md border-white/5 focus:border-primary/40 focus:ring-primary/10 resize-none font-sans text-base placeholder:text-muted-foreground/20 transition-all duration-500 rounded-2xl p-8 leading-relaxed shadow-2xl"
        />
